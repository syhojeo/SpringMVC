...
<body>
	...
	<form action="result" method="post">
		...
		주소 1 : <input type="text" name="user_address" value="${requestScope.userDataBean.user_address }"><br>
		주소 2 : <input type="text" name="user_address2" value="${requestScope.userDataBean.user_address2 }"><br>
