...
public class TestController {
	...
	@GetMapping("/test3")
	public String teset3(@ModelAttribute("testBean") UserDataBean bean) {
	...
	@GetMapping("/test4")
	public String teset4(Model model) {
